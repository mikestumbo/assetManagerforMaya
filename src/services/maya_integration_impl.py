...
class MayaIntegrationImpl(IMayaIntegration):
    ...
    def _import_usd_file(self, file_path: Path, options: Dict[str, Any]) -> bool:
        """
        Import USD file with automatic skinCluster creation
        Single Responsibility: handle USD import with skinning
        """
        try:
            # Import USD service
