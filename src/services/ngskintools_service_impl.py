...
if TYPE_CHECKING:
    try:
        import ngSkinTools2.api  # type: ignore # noqa: F401
        from ngSkinTools2.api import Layers, init_layers, target_info  # type: ignore # noqa: F401
    except ImportError:
        pass
...
class NgSkinToolsService:
    ...
    def detect_ngskintools_nodes(self, namespace: Optional[str] = None) -> Dict[str, List[str]]:
        ...
        try:
            ...
            self.logger.debug(
                f"Detected {result['total_nodes']} ngSkinTools2 nodes in namespace '{namespace or 'root'}'"
            )
    ...
    def get_scene_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(
                f"ngSkinTools2 scene summary: {summary['total_skin_clusters']} skinned meshes, "
                f"{summary['total_layers']} layers"
            )
