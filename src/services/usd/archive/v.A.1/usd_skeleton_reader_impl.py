...
class UsdSkeletonReaderImpl:
    ...
    def read_skeleton(self, stage: Any, skeleton_path: str) -> Optional[UsdSkeletonData]:
        ...
        try:
            ...
            has_animation = False
            # TODO: Check for animation tracks
    ...
    def read_skin_weights(
        ...
        try:
            ...
            if non_zero_weights > 0:
                self.logger.info(f"📊 Weight range (first 100 verts): min={min_weight:.6f}, max={max_weight:.6f}, non-zero={non_zero_weights}/{total_weights}")
